    ...
    <div>
      ...
      <div className='flex items-center justify-center mt-4 mb-2 m-auto md:w-[60%] w-[80%]'>
        <input
          ...
          className='border border-gray-300 outline-[#FFC0CB] p-2 mr-2'
        />
        {/* Category Filter */}
        <select
          value={selectedCategory}
          onChange={(e) => setSelectedCategory(e.target.value)}
          className='border border-gray-300 p-2 outline-[#FFC0CB]'
        >
        ...
        {/* Search Button */}
        <button onClick={handleSearch} className='bg-black rounded-lg  text-white p-2 ml-2 hover:text-[#FFC0CB]  hover:scale-105 transition'>Search</button>
      </div>
