...
const page = ({params}) => {
  ...
  return (
    <div>
        ...
        <button className='hover:bg-transparent bg-[#FFC0CB] w-[40%] md:w-[20%] block m-auto mt-7 p-2 py-3 border border-[#FFC0CB] transition rounded-2xl hover:text-black text-white mb-4 hover:scale-110 ' onClick={() => {router.push(`/events/${route}/contactForm`)}}>get ticket</button>
    </div>
  )
}
