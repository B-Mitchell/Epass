...
//   const checkIfOwner = () => {
//     if (userId === fetchedData?.[0]?.user_id) {
//       console.log(userId)
//       console.log(fetchedData?.[0]?.user_id)
//       console.log('this is the owner of the ticket')
//     } else {
//       console.log(userId)
...
//       <div className='border-2 w-[80%] md:w-[70%] m-auto'>
//         <p >Edit ticket</p>
...
//         <button
//           onClick={handleCopy}
//           className="flex items-center bg-[#FFC0CB] hover:bg-[#ff9dbd] p-2 px-4 rounded-lg border border-[#FFC0CB] transition"
//         >
