...
const Event_Ticket = (props) => {
  ...
  return (
    <div  className='w-[100%] h-auto md:w-[23rem] border border-[#FFC0CB]  rounded-lg overflow-hidden hover:scale-105 transition cursor-pointer relative' onClick={() => {router.push(`events/${uuid}`)}}>
      ...
      <div className='px-2 py-2'>
        ...
        <p className='text-[.9rem] absolute top-0 right-0 bg-[#FFC0CB] p-1 rounded-md'>{nops} left</p>
