...
const Event_Ticket = (props) => {
  ...
  return (
    <div  className='w-[100%] h-[27rem] md:w-[23rem] border border-[#E0BFB8]  rounded-lg overflow-hidden hover:scale-105 transition cursor-pointer relative' onClick={() => {router.push(`events/${uuid}`)}}>
