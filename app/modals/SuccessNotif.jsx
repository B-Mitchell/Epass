    ...
    <div >
        ...
        <div className='bg-white rounded-[2rem] md:w-[50%] w-[80%] m-auto md:mt-[15%] mt-[40%] p-4 border border-[#FFCOCB]'>
            ...
            <div className='w-[80%] pb-2 m-auto'>
                <button className='hover:bg-[#FFCOCB] w-[80%] block mt-7 p-2 m-auto border border-[#FFCOCB] transition rounded-2xl hover:text-white hover:scale-105' onClick={() => {router.push('/profile'); setAccountCreation(!accountCreation)}}>go to login</button>
            </div>
