    ...
    <div >
        ...
        <div className='bg-white rounded-[2rem] md:w-[50%] w-[80%] m-auto md:mt-[15%] mt-[40%] p-4 border border-[#FFC0CB]'>
            ...
            <div className='w-[80%] pb-2 m-auto'>
                <button className='hover:bg-[#FFC0CB] w-[80%] block mt-7 p-2 m-auto border border-[#FFC0CB] transition rounded-2xl hover:text-white hover:scale-105' onClick={() => {router.push('/profile'); setAccountCreation(!accountCreation)}}>go to login</button>
            </div>
