...
const ProfileTickets = (props) => {
  ...
  return (
    ...
    <div className='w-[100%] min-h-[25rem] h-fit pb-1 md:w-[23rem] border border-[#E0BFB8] rounded-lg overflow-hidden hover:scale-105 transition cursor-pointer relative' onClick={() => {router.push(`events/${uuid}`)}}>
  <Image src={`${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/ticketBucket/public/${user_id}_${image}`} alt='event image' className='w-[100%] min-h-[15rem] max-h-[15rem] h-full' width={400} height={400}/>
