...
const ProfileTickets = (props) => {
  ...
  return (
    ...
    // </div>
    <div  className='w-[100%]  min-h-[25rem] h-fit pb-1  md:w-[23rem] border border-[#E0BFB8]  rounded-lg overflow-hidden hover:scale-105 transition cursor-pointer' onClick={() => {router.push(`events/${uuid}`)}}>
