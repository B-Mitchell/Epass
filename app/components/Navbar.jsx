...
import { FaHome, FaCalendarAlt, FaInfoCircle, FaDollarSign, FaUser, FaSignInAlt, FaSignOutAlt, FaUserPlus, FaTimes, FaCompass } from 'react-icons/fa';
...
const NavBar = () => {
  ...
  const navItems = [
    ...
    // { name: 'Discover', path: '/events/discover', icon: FaCompass },
...
//     { name: 'Home', path: '/', icon: FaHome },
//     { name: 'Events', path: '/events', icon: FaCalendarAlt },
//     { name: 'Discover', path: '/events/discover', icon:  },
//     { name: 'About', path: '/about', icon: FaInfoCircle },
//     { name: 'Pricing', path: '/pricing', icon: FaDollarSign },
//   ];
